...
export default function Questions(props) {
    ...
    const onClick = (event) => {
        const button_color = document.getElementById(event.target.id).style.backgroundColor;
    ...
    return ( 
        ...
        <form className="questions-form" onSubmit={ handleSubmit }>
            <button id="question1" className="question-button" type="button" style={ { backgroundColor: "#f3f3f3" } } onClick={ onClick }> What is your ideal first date be like ?</button>
            <button id="question2" className="question-button" type="button" style={ { backgroundColor: "#f3f3f3" } } onClick={ onClick }> If you could meet someone dead or alive, who would it be ?</button>
            <button id="question3" className="question-button" type="button" style={ { backgroundColor: "#f3f3f3" } } onClick={ onClick }> What are some misconceptions people have about you ?</button>
            <button id="question4" className="question-button" type="button" style={ { backgroundColor: "#f3f3f3" } } onClick={ onClick }> What is your ideal place to live and why ? </button>
            <label> 
